...
{
    private void OnBrowserOpenClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
    ...
    private void OnBrowserBackClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        try
        {
    ...
    private void OnBrowserForwardClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        try
        {
    ...
    private void OnBrowserRefreshClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        try
        {
    ...
    private void OnBrowserNewTabClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
    ...
    private void OnBrowserTabPointerPressed(object? sender, PointerPressedEventArgs e)
    {
    ...
    private void OnBrowserTabCloseClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
    ...
    private void OnBrowserNavigationStarted(object? sender, WebView2NavigationStartingEventArgs e)
    {
        ViewModel?.BrowserPane.BeginNavigation(e.Url);
    }

    private void OnBrowserNavigationCompleted(object? sender, WebView2NavigationCompletedEventArgs e)
    {
    ...
    private void OnBrowserInitializationFailed(object? sender, WebView2InitializationFailedEventArgs e)
    {
